...
<div class="breadcrumb">	<h4>Pencari Kerja</h4></div>
  <ul id="tabs" class="breadcrumb nav nav-tabs" data-tabs="tabs">
		...
		<label>User ID</label>
<input type="text" name="userid"  value=<?=$username ?> class="form-control">
<label>	Kata Sandi</label>
<input type="password" name="sandi"  value=<?=$kata_sandi ?> class="form-control">
